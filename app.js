...
function scoreAudio(){
    var audioPlayer1 = document.getElementById('score-audio');
    audioPlayer1.play();
}
...
function updateScore() {
    var prevPlayerScore = myScore;
    var prevComputerScore = computerScore;
    compScore.innerHTML = computerScore;
    playerScore.innerHTML = myScore;
    
    if (prevPlayerScore > prevComputerScore) {
        scoreAudio();
    }
}
